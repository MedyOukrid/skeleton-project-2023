 ...
 */
final class Version20230726073335 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE listing (id INT AUTO_INCREMENT NOT NULL, model_id INT NOT NULL, title VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, produced_year INT NOT NULL, mileage INT NOT NULL, price INT NOT NULL, created_at DATETIME NOT NULL, image VARCHAR(500) NOT NULL, INDEX IDX_CB0048D47975B7E7 (model_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
